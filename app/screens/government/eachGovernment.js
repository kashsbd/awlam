...
import { GovernmentItem } from './components/governmentItem';
import { Color } from '../../utils/color';

export class EachGovernment extends React.PureComponent {

    static navigationOptions = ({ navigation }) => ({
        title: 'Each Government Post',
        headerStyle: {
    ...
    async getData() {
        ...
        const url = governmentUrl + '/' + postId;
