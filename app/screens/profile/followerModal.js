...
export class FollowerModal extends PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            modalVisible: false,
    ...
    open = () => {
        ...
        const url = baseUrl + '/users/' + userId + '/followers';
    ...
    renderEmptyView = () => {
        return (
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                ...
                <Text style={{ color: Color.backgroundColor, fontWeight: '600', fontSize: 18 }}>No Followers Yet</Text>
            </View>
        )
    }
