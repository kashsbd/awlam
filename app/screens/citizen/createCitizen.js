...
export class CreateCitizen extends Component {

    static navigationOptions = ({ navigation }) => ({
        title: 'Create Citizen Post',
    ...
    uploadData = async () => {
        ...
        if (description.trim().length === 0 && images.length === 0) {
            ...
            try {
                let res = await futch(citizenUrl, config, this._onProgress);
                this.setState({ showActivityIndicator: false });
                Alert.alert(
                    'Notice',
                    'Your post is being reviewed by Awlam team.We will inform you when your post is ready.Thanks for your patience.',
                    [
                        { text: 'OK', onPress: this._exitPage },
                    ],
                    { cancelable: false }
                );
            } catch (error) {
            ...
            <View style={{ flex: 1 }}>
                ...
                >
                    ...
                    <View style={styles.bottomStyle}>
                        ...
                        <View >
                            <Text style={{ color: Color.backgroundColor, marginHorizontal: 12, marginVertical: 8 }}>Tag Location</Text>
