...
export class CitizenList extends PureComponent {
    ...
    getData() {
        ...
        const url = citizenUrl + '/?page=' + page + '&role=' + LoggedUserCredentials.getRole();
    ...
    _renderItem = ({ item }) => {
        return (
            <CitizenItem feed={item} {...this.props} />
        )
    }
    ...
    _navigate = () => {
        this.props.navigation.navigate('CreateCitizen', { 'updatePost': this.updatePost });
    }
