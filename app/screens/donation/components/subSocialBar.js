...
import { DonationCommentList } from './';
...
export class SubSocialBar extends React.Component {
    ...
    onLike = () => {
        ...
        if (isLiked) {
            ...
            url = donationUrl + '/subposts/' + feedId + '/unlike';
        } else {
            this.setState({ isLiked: true, likesCount: likesCount + 1 });
            url = donationUrl + '/subposts/' + feedId + '/like';
        }
    ...
    onUnLike = () => {
        ...
        if (isDisliked) {
            ...
            url = donationUrl + '/subposts/' + feedId + '/undislike';
        } else {
            this.setState({ isDisliked: true, unlikesCount: unlikesCount + 1 });
            url = donationUrl + '/subposts/' + feedId + '/dislike';
        }
    ...
    async getComments() {
        ...
        const url = donationUrl + '/subposts/' + feedId + '/comments';
