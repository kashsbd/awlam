...
import { SubDonationItem } from './components';
...
export class SubDonationPostList extends PureComponent {

    static navigationOptions = ({ navigation }) => ({
        title: 'Donation Sub Posts',
        headerStyle: {
    ...
    componentDidMount() {
        ...
        this.setState({ did }, () => this.getData());
    }

    getData() {
        const { page, posts, did } = this.state;

        const url = eventUrl + '/' + did + '/subposts?page=' + page;
    ...
    onInterested() {
        ...
        const url = eventUrl + '/' + did + '/interested';
    ...
    onUnInterested() {
        ...
        const url = eventUrl + '/' + did + '/uninterested';
    ...
    onUnGoing() {
        ...
        const url = eventUrl + '/' + did + '/ungoing';
    ...
    _renderItem = (eachPost) => {
        ...
        return (
            <SubDonationItem feed={post} {...this.props} />
        )
    }
    ...
    _navigate = () => {
        this.props.navigation.navigate('CreateEventPost', { 'updatePost': this.updatePost, 'did': this.state.did });
    }
