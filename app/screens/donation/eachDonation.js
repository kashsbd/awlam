...
export class EachDonation extends React.PureComponent {
    ...
    componentDidMount() {
        ...
        this.setState({ postLoading: true, did }, () => this.getData());
    }
    ...
    renderListHeader = () => {
        ...
        if (post) {
            return (
                <DonationItem feed={post} {...this.props} />
            )
        }
