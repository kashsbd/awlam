...
export class DonationList extends PureComponent {
    ...
    getData() {
        ...
        const url = donationUrl + '/?page=' + page + '&role=' + LoggedUserCredentials.getRole();
    ...
    _navigate = () => {
        this.props.navigation.navigate('CreateDonation', { 'updatePost': this.updatePost });
    }
