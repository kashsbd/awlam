...
export class PopularPostList extends React.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            //selected feed id
    ...
    getData() {
        ...
        const url = baseUrl + '/posts/getPopularPosts?page=' + page;
    ...
    renderNoFeeds() {
        return (
            <View style={styles.centerLoading}>
                ...
                <RkText style={{ color: Color.backgroundColor }}>No hot posts to show !</RkText>
            </View>
        )
    }
