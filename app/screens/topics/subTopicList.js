...
import { TopicItem, SubTopicItem } from './components';
...
import { baseUrl, topicUrl } from '../../utils/globle';
import { scale } from '../../utils/scale';
import LoggedUserCredentials from '../../utils/modal/LoggedUserCredentials';

export class SubTopicList extends PureComponent {

    static navigationOptions = ({ navigation }) => ({
        title: 'Topic Sub Posts',
        headerStyle: {
    ...
    componentDidMount() {
        ...
        this.setState({ tid }, () => this.getData());
    }

    getData() {
        const { page, posts, tid } = this.state;

        const url = topicUrl + '/' + tid + '/subposts?page=' + page;
    ...
    _renderItem = (eachPost) => {
        ...
        return (
            <SubTopicItem feed={post} {...this.props} />
        )
    }
    ...
    _navigate = () => {
        this.props.navigation.navigate('CreateSubTopic', { 'updatePost': this.updatePost, 'tid': this.state.tid });
    }
