...
export class PermittedPeopleModal extends PureComponent {
    ...
    getData() {
        ...
        const url = baseUrl + '/users/' + LoggedUserCredentials.getUserId() + '/followerfollowings?page=' + page;
    ...
    searchUser(quary) {
        ...
        const url = baseUrl + '/users/' + LoggedUserCredentials.getUserId() + '/search?query=' + quary;
    ...
    _onSelect = (user) => {
        const index = _.findIndex(this.filtered_users, { _id: user._id });
        if (index === -1) {
    ...
    renderEmptyView = () => {
        return (
            <View style={styles.centerContent}>
                ...
                <Text style={{ color: Color.backgroundColor, fontWeight: '600', fontSize: 18 }}>No Followers And Followings Yet</Text>
            </View>
        )
    }
    ...
    _handleTextInput = text => this.setState({ quary: text }, () => this.searchUser(text));
    ...
    close = () => this.setState({ modalVisible: false }, () => {
        ...
        onComplete && onComplete(this.filtered_users);
    });

    open = () => this.setState({ modalVisible: true }, () => this.getData());
            ...
            >
                <View style={styles.root}>
                    <View style={styles.headerBar}>
                        ...
                        <RkText style={{ paddingTop: scale(8), marginLeft: scale(15), color: '#fff' }}>Invite Friends</RkText>
                    </View>
